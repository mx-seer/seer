...
Download the latest binary for your platform from the [Releases page](https://github.com/mx-seer/seer/releases/latest).

Available platforms: Linux (x64, ARM64), macOS (Intel, Apple Silicon), Windows (x64)
